  ...
  return (
    <>
      <form id="consentForm" className="">
          ...
          <div className="form-fields">
            <label htmlFor="yourname" className="">
              ...
              <input
                ...
                value={yourname}
                onChange={(event) => {
                  setyourname((prev) => (prev = event.target.value));
                }}
                required
                data-level="0"
              />
            </label>
            <label htmlFor="currentdate" className="">
              Date
              <input
                className=""
                type="date"
                ...
                value={currentdate}
                onChange={(event) => {
                  setcurrentdate((prev) => (prev = event.target.value));
                }}
                required
                data-level="0"
              />
        ...
        <button className="" onClick={(event) => handleSubmit(event)}>
          Submit
        </button>
      </form>
      <p>{apiStatus === "loading" ? "Generating PDF" : apiStatus}</p>
    </>
  );
};
